...
The method by which a passage is judged to read as machine-made, its justification and its
measured precision are in [ai-style-methodology.md](ai-style-methodology.md).
